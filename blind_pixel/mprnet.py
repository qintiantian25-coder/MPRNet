...
Original MPRNet model — kept exactly as published, without any architectural modifications.
Used here for blind pixel restoration via channel replication (grayscale → 3-channel RGB).
"""
